<header id="tg-header" class="tg-header tg-headervtwo tg-haslayout">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <div class="tg-userlogin">
                        <figure><a href="javascript:void(0);"><img src="{{ asset('assets/images/users/img-01.jpg') }} " alt="image description"></a></figure>
    ...
    <div class="tg-middlecontainer">
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <strong class="tg-logo"><a href="index.html"><img src="{{ asset('assets/images/logo.png') }} " alt="company name here"></a></strong>
                                    ...
                                    <div class="mega-menu">
                                        ...
                                        <div class="tab-content tg-themetabcontent">
                                            <div role="tabpanel" class="tab-pane active" id="artandphotography">
                                                ...
                                                <ul>
                                                    <li>
                                                        <figure><img src="{{ asset('assets/images/img-01.png') }} " alt="image description"></figure>
                                ...
                                <div class="dropdown-menu tg-themedropdownmenu" aria-labelledby="tg-minicart">
                                    <div class="tg-minicartbody">
                                        <div class="tg-minicarproduct">
                                            <figure>
                                                <img src="{{ asset('assets/images/products/img-01.jpg') }} " alt="image description">
                                        ...
                                        <div class="tg-minicarproduct">
                                            <figure>
                                                <img src="{{ asset('assets/images/products/img-02.jpg') }} " alt="image description">
                                        ...
                                        <div class="tg-minicarproduct">
                                            <figure>
                                                <img src="{{ asset('assets/images/products/img-03.jpg') }} " alt="image description">
