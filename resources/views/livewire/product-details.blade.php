										...
										<div class="row">
											<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
												<div class="tg-postbook">
													<figure class="tg-featureimg"><img src="{{ asset('assets/images/books/img-07.jpg ') }}" alt="image description"></figure>
											...
											<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
												<div class="tg-productcontent">
													...
													<div class="tg-alsoavailable">
														<figure>
															<img src="{{ asset('assets/images/img-02.jpg') }}" alt="image description">
															<figcaption>
...
voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
																<figure class="tg-alignleft">
																	<img src="{{ asset('assets/images/placeholdervtwo.jpg') }}" alt="image description">
												...
												<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
													...
													<div class="tg-authorbox">
														<figure class="tg-authorimg">
															<img src="{{ asset('assets/images/author/imag-24.jpg') }}" alt="image description">
														</figure>
